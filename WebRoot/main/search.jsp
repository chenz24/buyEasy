...
<div class="wrap">
    <div class="main">
        ...
        <div class="main_left">
        	<div class="position">
            	<a href="index.do" title="首页">首页</a><a href="#">搜索</a>
            </div>
            <!--上下分页-->
            <div class="pagebar">
            	${simplePage}
            ...
            <div class="condition-filter">
                <ul>
                    ...
                    <li class="price"><a href="${currurl}&query.order=${priceorder}" title="点击按价格从低到高排序">价格</a></li>
...
<s:iterator value="books" status="state">                
                <div class="books-list">
                    <h3 class="summary"><a href="#" target="_blank" class="l">${title}</a> &nbsp;</h3>
                    <div class="photo"><a href="#" target="_blank"><img src="${thumb}" width="150" height="150" alt="${title}" ></a></div>
                    <ul class="books-info">
                        <li>作者：<a href="search.do?query.author=${author}" target="_blank"><s:property value="author" /></a></li>
                        <li></li>
                        <li>出版社：<a target="_blank" href="search.do?query.publisher=${publisher}"><s:property value="publisher" /></a></li>
                        <li>出版时间：<s:property value="publish_time" /></li>
                    </ul>
                    <p class="mt5 text2">${description}</p>
